// src/lib.rs
/*
 * Core library for AudioLectures
 */
...
#[derive(Debug)]
pub struct AudioLecturesProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AudioLecturesProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AudioLectures processing");
    
    let mut processor = AudioLecturesProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AudioLecturesProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AudioLecturesProcessor::new(false);
